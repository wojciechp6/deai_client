...
function generate_did() {
  local canister=$1
  canister_root="examples/$canister"
  ...
  ~/.cargo/bin/candid-extractor "target/wasm32-unknown-unknown/release/$canister.wasm" > "$canister_root/$canister.did"

  ~/.cargo/bin/ic-wasm "target/wasm32-unknown-unknown/release/$canister.wasm" \
